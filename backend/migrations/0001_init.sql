...
-- ══════════════════════════════════════════
-- ROW LEVEL SECURITY (Multiempresa) — removed for RRHH-Go.
-- The original Supabase RLS policies relied on auth.jwt(), which only
-- exists in Supabase's managed Postgres (via GoTrue). RRHH-Go enforces
-- company_id tenant isolation in the Go middleware instead (see
-- internal/auth.Middleware) — every query goes through that context value.
-- ══════════════════════════════════════════
